          ...
          <div class="col-lg-3">
            <article class="white-block">
              <div class="top-cat-title">
                ...
                <p>28 Categories, 1400 Books</p>
              </div>
              <ul class="top-cat-list">
                <li>
                  <a href="##">
                    <div class="top-cat-list__title">
                      Fantasy <span>11.2k</span>
                    </div>
                    <div class="top-cat-list__subtitle">
                      Fantasy Novels <span class="purple">+472</span>
                    </div>
                  </a>
                </li>
                <li>
                  <a href="##">
                    <div class="top-cat-list__title">
                      Historical Fiction <span>11k</span>
                    </div>
                    <div class="top-cat-list__subtitle">
                      Historical Fiction Books <span class="blue">+472</span>
                    </div>
                  </a>
                </li>
                <li>
                  <a href="##">
                    <div class="top-cat-list__title">
                      Technology <span>10.8k</span>
                    </div>
                    <div class="top-cat-list__subtitle">
                      Daily technology Books <span class="danger">+472</span>
                    </div>
                  </a>
                </li>
                <li>
                  <a href="##">
                    <div class="top-cat-list__title">
                      Detective & Mystery <span>10.7k</span>
                    </div>
                    <div class="top-cat-list__subtitle">
                      Mystery and Thriller Books <span class="success">+472</span>
                    </div>
                  </a>
                </li>
                <li>
                  <a href="##">
                    <div class="top-cat-list__title">
                      Romance <span>10.2k</span>
                    </div>
                    <div class="top-cat-list__subtitle">
                      Romance books under Fiction <span class="warning">+472</span>
                    </div>
                  </a>
                </li>
                <li>
                  <a href="##">
                    <div class="top-cat-list__title">
                      Science Fiction <span>9.9k</span>
                    </div>
                    <div class="top-cat-list__subtitle">
                      Science Fiction Books <span class="warning">+472</span>
                    </div>
                  </a>
                </li>
                <li>
                  <a href="##">
                    <div class="top-cat-list__title">
                      Business/Economics <span>9.5k</span>
                    </div>
                    <div class="top-cat-list__subtitle">
                      Business & Finance Books <span class="warning">+472</span>
                    </div>
                  </a>
                </li>
                <li>
                  <a href="##">
                    <div class="top-cat-list__title">
                      Health/Fitness <span>8.8k</span>
                    </div>
                    <div class="top-cat-list__subtitle">
                      Lifestyle & Health Books <span class="primary">+472</span>
                    </div>
                  </a>
                </li>
              </ul>
